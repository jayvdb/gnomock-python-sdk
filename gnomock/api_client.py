...
from gnomock.exceptions import ApiTypeError, ApiValueError, ApiException
from gnomock.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PresetsApi()
        api_instance.start_cassandra  # this is an instance of the class Endpoint
        api_instance.start_cassandra()  # this invokes api_instance.start_cassandra.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.start_cassandra.callable or self.callable in this class
